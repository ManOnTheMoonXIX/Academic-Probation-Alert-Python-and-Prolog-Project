...
% Module Details (Student ID, Module ID, Year, Semester, LetterGrade)
module_details(1234567, 'MAT2003', 2023, 1, 'A+').
module_details(1234567, 'CMP4011', 2023, 1, 'B+').
module_details(1234567, 'CIT3009', 2024, 2, 'C+').
module_details(2345678, 'MAT2003', 2023, 1, 'D+').
module_details(2345678, 'CIT2011', 2023, 1, 'F').
module_details(2345678, 'PSY1002', 2024, 2, 'A-').
module_details(3456789, 'ENT3001', 2023, 1, 'B-').
module_details(3456789, 'COM1024', 2023, 1, 'C-').
module_details(4567890, 'MAT1043', 2023, 1, 'D-').
module_details(4567890, 'STA2020', 2024, 2, 'F').
module_details(5678901, 'MAT2003', 2023, 1, 'A+').
module_details(5678901, 'CMP4011', 2023, 1, 'B+').
module_details(5678901, 'CIT3009', 2024, 2, 'C+').
module_details(6789012, 'MAT2003', 2023, 1, 'D+').
module_details(6789012, 'CIT2011', 2023, 1, 'F').
module_details(6789012, 'PSY1002', 2024, 2, 'A-').
module_details(7890123, 'ENT3001', 2023, 1, 'B-').
module_details(7890123, 'COM1024', 2023, 1, 'C-').
module_details(8901234, 'MAT1043', 2023, 1, 'D-').
module_details(8901234, 'STA2020', 2024, 2, 'F').
...
calculate_gpa(StudentID, Semester, GPA) :-
    findall(GradePoints * Credits, (
        module_details(StudentID, ModuleID, _, Semester, LetterGrade),
